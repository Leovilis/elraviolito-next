...
export default function Capeletis() {
  ...
  const capeletisSimples = [
    ...
    },
    {
      ...
      descripcion: "Verduras frescas combinadas con queso cremoso en forma tradicional del capeleti.",
      imagen: "/capeletis-verdura-y-queso.jpg",
      ingredientes: ["Verduras", "Queso cremoso", "Especias", "Un touch de Sal", "Masa Fresca de El Raviolito"],
      tipoPrecio: "simple",
      categoria: "Simple"
    },
    {
      ...
      ingredientes: ["Verduras", "Ricota", "Especias", "Un touch de Sal", "Masa Fresca de El Raviolito"],
      tipoPrecio: "simple",
      categoria: "Simple"
    },
    {
      ...
      ingredientes: ["Verduras", "Picadillo de Carne", "Especias", "Un touch de Sal", "Masa Fresca de El Raviolito"],
      tipoPrecio: "simple",
      categoria: "Simple"
    },
    {
      ...
      ingredientes: ["Verduras", "Pollo", "Especias", "Un touch de Sal", "Masa Fresca de El Raviolito"],
      tipoPrecio: "simple",
      categoria: "Simple"
    }
  ];
  ...
  const capeletisEspeciales = [
    ...
    },
    {
      ...
      descripcion: "Calabaza dulce asada con queso mozzarella, un sabor suave y delicado en forma de capeleti.",
    ...
    },
    {
      ...
      descripcion: "Quatro Quesos combinados en una suave masa para un exquisito sabor en forma de capeleti.",
      imagen: "/capeletis-4quesos.jpg",
      ingredientes: ["Mozzarella", "Queso Azul", "Parmesano", "Ricota", "Especias", "Un touch de Sal", "Masa Fresca de El Raviolito"],
      tipoPrecio: "premium",
      categoria: "Especial"
    },
    {
      ...
      descripcion: "Batata con un touch de Queso Azul envuelta en una suave masa, un sabor único e innovador.",
        ...
        <div className="container mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
              Los capeletis con su característica forma de sombrero vienen en {PRECIOS.capeletis.descripcion}.
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm md:text-base">
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow">
                ...
                <span>{PRECIOS.capeletis.descripcion}</span>
              </div>
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {capeletisSimples.map((capeleti) => (
              <ProductCard key={capeleti.id} producto={capeleti} bgColor="bg-green-500" />
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {capeletisEspeciales.map((capeleti) => (
              <ProductCard key={capeleti.id} producto={capeleti} bgColor="bg-tomato" />
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Cocina por {tiempoCoccion} con cuidado para mantener su forma.
              </p>
            </div>
      ...
      <section id="whatsapp" className="py-16 bg-tomato text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="font-script text-4xl md:text-5xl mb-6">
            {PRECIOS.capeletis.descripcion} Únicos
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Nuestros capeletis vienen en porciones perfectas de {PRECIOS.capeletis.descripcion},
